...
class derived : private base {//we are deriving a class
    int data3;
    int call;
    int setdata22;
    public:
...
int derived :: display () {
    ...
    cout <<"aafter changing visibility mode for the same program and adding another function :"<<setdata2() <<endl;
    }
